...
These supplies include a mundane inexhaustible inkpot, quill and sheaf of paper, sufficient for writing letters or crafting a [_Spell Scroll_](https://www.dndbeyond.com/magic-items/9229085-spell-scroll) by the normal rules. When doing so, you may use supply items to add their effects. The maximum spell level depends on rarity (see the _Rarity and Contents_ table). Using supply items to craft resolves first to the writer&rsquo;s order of supplies, then the spell. The spell itself is always cast normally.
...
_Favored by generals and saboteurs, this ink sparks._
...
_Favored by spies and lovers, this ink leaves only a faint lemony scent._
As an action, you can write invisibly with this ink. Writing made this way remains invisible until revealed by heat, such as holding the page near a flame. The effect applies only to mundane writing, not magical text such as spell scrolls or glyphs.
...
_Favored by charlatans and smugglers, this ink hides its trail._
Writing made with this ink fades after 1 hour. The text reappears only under moonlight or with magical detection (such as [_Detect Magic_](https://www.dndbeyond.com/sources/dnd/br-2024/spell-descriptions#DetectMagic)).
...
_Favored by scholars and the curious, this quill knows more than you._
When you write with this quill, margin notes appear, automatically recording rumors or lore related to subjects you mention but no more than once on a page.
...
_Favored by magistrates and devils, this paper enforces oaths._
...
_Favored by scouts and sergeants, these notes are for quick reference._
...
_Favored by calligraphers and copyists, these blue papers echo every quill stroke._
...
_Favored by the nosy, this reflective paper reflects more than words._
The first creature that reads the page must succeed on a DC 15 Wisdom saving throw or be affected as if by the _Scrying_ spell. The spell requires no components, lasts for 10 minutes, and doesn't use a spell slot.

_**Origami Paper (Uncommon).**_
_Favored by entertainers and spies, this paper folds itself into living shapes._
...
This sheaf is 5 sets of paired pages. When you write or mark on this paper, those appear instantly on its paired page within the same plane.

_**Research Paper (Common).**_
_Favored by apprentices and investigators, this paper distills insights into practice._
When you write on this paper, choose one ability (Strength, Dexterity, Constitution, Intelligence, Wisdom, or Charisma). The first creature that reads the page before making an ability check using that ability can roll a d4 and add the result.

_**Trailblazer Map (Uncommon).**_
_Favored by scouts and couriers, these notes sketch the way forward._
When you write the name of a specific place or landmark within 3 miles (such as &ldquo;City of Greyhawk&rdquo; or &ldquo;Wizard&rsquo;s Tower&rdquo;), the page orients itself and appears a faint, shifting outline showing the quickest route considering terrain. The map is vague, hinting at direction rather than detail, and updates as you travel. This paper cannot locate creatures or unspecified objects (such as &ldquo;the nearest obelisk&rdquo;). It functions on land or sea, but not underground or across planar boundaries.

_**Vocal Paper (Uncommon).**_
_Favored by illiterate readers, this paper speaks its words._
When read it speaks its contents aloud in the language it was written in.
